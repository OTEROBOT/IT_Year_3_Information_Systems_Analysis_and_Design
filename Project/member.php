...
<head>
    <meta charset="UTF-8">
    <title>แดชบอร์ดสมาชิกชมรม</title>
...
<body>
    <div class="container mt-5">
        <div class="text-center mb-4">
            ...
            <h2 class="text-primary">ยินดีต้อนรับ, <?php echo $_SESSION['username']; ?> (Member)</h2>
        </div>
        <div class="card p-4 shadow-lg">
            <p class="lead text-muted">ที่นี่คือหน้าสำหรับสมาชิก คุณสามารถลงทะเบียนกิจกรรมและดูประวัติได้</p>
